package com.alias.test.domain.strategy;
...
import com.alias.domain.strategy.model.valobj.*;
...
public class LogicTreeTest {
    ...
    public void test_tree_rule() {
        ...
        DefaultTreeFactory.StrategyAwardVO data = treeEngine.process("scy", 100001L, 100);
