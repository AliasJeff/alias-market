package com.alias.test.domain.award;
...
import com.alias.domain.award.model.valobj.AwardStateVO;
import com.alias.domain.award.service.IAwardService;
...
public class AwardServiceTest {
    ...
    public void test_saveUserAwardRecord() throws InterruptedException {
        for (int i = 0; i < 100; i++) {
            ...
            userAwardRecordEntity.setUserId("scy");
