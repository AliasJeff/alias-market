package com.alias.domain.strategy.service.rule.tree.factory.engine.impl;

import com.alias.domain.strategy.model.vo.RuleLogicCheckTypeVO;
import com.alias.domain.strategy.model.vo.RuleTreeNodeLineVO;
import com.alias.domain.strategy.model.vo.RuleTreeNodeVO;
...
public class DecisionTreeEngine implements IDecisionTreeEngine {
    ...
    public DefaultTreeFactory.StrategyAwardVO process(String userId, Long strategyId, Long awardId) {
        DefaultTreeFactory.StrategyAwardVO strategyAwardDO = null;
        ...
        while (null != ruleTreeNode) {
            ...
            strategyAwardDO = logicEntity.getStrategyAwardVO();
