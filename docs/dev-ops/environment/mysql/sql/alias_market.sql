...
CREATE database if NOT EXISTS `alias_market` default character set utf8mb4 collate utf8mb4_0900_ai_ci;
...
(1,100001,101,2,'rule_random','1,1000','随机积分策略','2023-12-09 10:05:30','2023-12-09 12:55:52'),
	...
	(13,100001,NULL,1,'rule_weight','4000:102,103,104,105 5000:102,103,104,105,106,107 6000:102,103,104,105,106,107,108,109','消耗6000分，必中奖范围','2023-12-09 10:30:43','2023-12-09 12:58:21'),
	(14,100001,NULL,1,'rule_blacklist','100:user001,user001,user003','黑名单抽奖，积分兜底','2023-12-09 12:59:45','2023-12-09 13:42:23');
